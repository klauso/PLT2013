...
What would you have to do in both version, respectively, to
...
You do not need to describe the actual changes or implementations of (1), (2)
and (3).  Instead outline briefly what you would have to do in both versions,
and describe to what extent the two versions differ.
