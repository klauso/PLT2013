...
why a polymorphic type `R` is chosen above.  Since it can be chosen
arbitrarily by need, `Nothing` was chosen in the [1st
lecture](../../lecturenotes/13-cpstransformation.scala) on
CPS-transformation.  So for all the coninuations you will introduce when
manually CPS-transforming the three functions above, you can also choose any
return type you want or leave it as polymorphic.
